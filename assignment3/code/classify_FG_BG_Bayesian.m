function [prob_error_1, prob_error_2] = classify_FG_BG_Bayesian(img, seg_mask_gt, zigzag_pat_lin, TS_FG, TS_BG, strategy, dataset, alpha)
...
%     title('Padded Image')
    ...
    imwrite(seg_mask_res, "../plots/S"+strategy+"_D"+dataset+"/seg_mask_res_alpha_"+alpha+".png");
    close all;
end